...
const Crypto = () => {
  ...
  const onSearch = (text) => {
    let filteredData = data.filter((f) =>
      f.name.toLocaleLowerCase().includes(text)
    );
          ...
          <Panel header="Crypto Tracker">
            ...
            >
              ...
              <Column flexGrow={1} align="left">
                ...
                <Cell dataKey="symbol">
                  {(rowData) => `$${rowData.symbol.toUpperCase()}`}
                </Cell>
              </Column>
              <Column flexGrow={1} align="left" sortable>
                <HeaderCell>Price</HeaderCell>
                <Cell dataKey="current_price">
                  {(rowData) => `$${rowData.current_price}`}
                </Cell>
              </Column>
              <Column flexGrow={1} align="left" sortable>
                ...
                <Cell dataKey="price_change_percentage_24h">
                  {(rowData) => (
                    <div
                      style={{
                        color: /-/i.test(rowData.price_change_percentage_24h)
                          ? "#ff0374"
                          : "#06a847",
                      }}
                    >
